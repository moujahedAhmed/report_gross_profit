...
def execute(filters=None):
	...
	group_wise_columns = frappe._dict({
		...
		"item_code_and_customer": ["customer", "customer_group", "posting_date","item_code", "item_name",
...
class GrossProfitGenerator(object):
	...
	def get_average_rate_based_on_group_by(self):
		...
		for key in self.grouped.keys():
			if self.filters.get("group_by") != "Invoice" and self.filters.get("group_by") != "Item Code and Customer":
	...
	def load_invoice_items(self):
		...
		if self.filters.group_by=="Sales Person":
			...
			sales_person_cols = ""
			sales_team_table = ""
		if self.filters.get("group_by") != "Item Code and Customer":
